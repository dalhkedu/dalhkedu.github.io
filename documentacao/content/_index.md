...
[![Youtube Badge](https://img.shields.io/badge/-Sou%20Sênior-red?style=flat-square&logo=Youtube&logoColor=white&link=https://www.youtube.com/@dalhkedu)](https://www.youtube.com/@dalhkedu)

---

## Sobre Mim

Atuo na interseção entre **alta complexidade técnica**, **viabilidade econômica** e **psicologia do usuário**. Minha trajetória evoluiu da engenharia de software pura para a Arquitetura de Ecossistemas Digitais, onde utilizo tecnologia para remover ineficiências sistêmicas e barreiras de mercado.

Com uma base sólida em ambientes de **missão crítica** (Setor Bancário/Fintech) e uma formação multidisciplinar que vai da Análise de Sistemas à Inteligência Artificial e Fotografia, meu foco é desenhar soluções que sejam tecnicamente robustas, esteticamente funcionais e financeiramente sustentáveis.

> **Minha Filosofia:** A tecnologia não é o fim, mas o meio para atingir eficiência operacional máxima e resolver problemas de fricção econômica.

---

## Stack e Competências

* **Arquitetura:** Microsserviços, Event-Driven Architecture, Serverless, Sistemas Distribuídos.
* **Back-end:** Java (Spring Ecosystem), Python.
* **Cloud & DevOps:** AWS, CI/CD, Docker, Kubernetes.
* **Dados & AI:** Generative AI (RAG, Vision), NLP, Data Science.
* **Negócios & Processos:** Lean Six Sigma, Engenharia Financeira (Securitização/CRI), Liderança Técnica.
...
* **Itaú Unibanco (2021 - 2025):** Atuação em modernização de sistemas legados e construção de soluções em nuvem AWS de alta disponibilidade e escala massiva. Foco em consistência, resiliência e o Teorema CAP.
* **Banco Original (2019 - 2021):** Experiência fundamental na transição de monólitos para arquiteturas de microsserviços em contexto financeiro.

---

## Formação Acadêmica

* **MBA em Tecnologia para Negócios: AI, Data Science e Big Data** (PUCRS - Em andamento)
* **Pós-graduação em Arquitetura de Software Distribuído** (PUC Minas)
* **Bacharelado em Análise e Desenvolvimento de Sistemas** (Senac)
* **Bacharelado em Fotografia** (UniSant'Anna) - *A base da minha capacidade de comunicação visual e narrativa técnica.*
...
[LinkedIn](https://www.linkedin.com/in/dalhkedu/) • [Email](mailto:dalhekdu@gmail.com)
